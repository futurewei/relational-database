...
public class SNLJOperator extends JoinOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    ...
    try {
      ...
      int leftNumRecordsPerPage = this.getLeftSource().getStats().getNumRecords() / this.getLeftSource().getStats().getNumPages();
      int rightNumPages = this.getRightSource().getStats().getNumPages();
      estimateCost = (leftNumRecordsPerPage * leftNumPages) * rightNumPages + leftNumPages;
    }catch (Exception e)
    {
      return -1;
    }
